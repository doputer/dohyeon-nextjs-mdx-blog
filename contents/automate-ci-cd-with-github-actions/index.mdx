...
팀 프로젝트로 웹 서비스를 개발하면서 GitHub Actions로 CI/CD를 구성한 경험을 정리합니다.
...
이 프로젝트는 매주 데모 시연으로 진행 상황을 공유하는 일정이었습니다. 시연에서 받은 피드백을 다음 주에 반영하려면 배포가 잦을 수밖에 없었습니다.
...
배포 서버로는 네이버 클라우드 플랫폼(nCloud)을 사용했습니다. 서버에 접속해서 빌드하고 PM2 reload로 무중단 실행하는 과정입니다.
