...
PNG SPEC v1.2[^1] 문서를 보면 PNG 포맷의 자세한 스펙이 적혀있다.
...
[^1]: [PNG (Portable Network Graphics) Specification, Version 1.2](https://www.libpng.org/pub/png/spec/1.2/PNG-Contents.html)
