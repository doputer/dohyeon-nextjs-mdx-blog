...
const LIST = cn(
  'list-inside leading-[1.9] marker:text-soft [&_ol]:my-0 [&_ol]:ml-6 [&_ul]:my-0 [&_ul]:ml-6'
);
...
export const external = cn(
  'after:align-super after:text-[0.65em] after:text-soft after:content-["↗"]'
);
