...
// Base
const HEADING = cn('mt-8 mb-4 scroll-mt-4 font-semibold');
...
export const code = cn('bg-surface rounded-sm px-1 py-0.5 text-sm');
...
export const a = cn('text-link font-medium underline underline-offset-4');
