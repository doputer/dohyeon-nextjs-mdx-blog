...
export const blockquote = cn('border-l-2 border-accent py-0.5 pl-4 text-soft');
export const callout = cn('flex gap-4 rounded-[10px] border border-accent/20 bg-accent/5 p-4');
export const code = cn('rounded-[5px] bg-accent/10 px-1.5 font-mono text-sm text-code-inline');
...
export const a = cn(
  'text-accent underline decoration-1 underline-offset-[3px] after:content-["↗"]'
);
